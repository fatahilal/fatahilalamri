<?php
$id=$_GET['id'];
$ambil=  mysqli_query($koneksi, "SELECT * FROM arsipkom WHERE nomor ='$id'") or die ("SQL Edit error");
        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">Form Update Data Murid Komputer</h3>
                </div>
...
if($_POST){
    ...
    $tgl_masuk=$_POST['tgl_masuk'];
     $status=$_POST['status'];
    //buat sql
    $sql="UPDATE arsipkom SET nomor='$nomor',no_kk='$no_kk',nama='$nama',alamat='$alamat',no_telpon='$no_telpon',
