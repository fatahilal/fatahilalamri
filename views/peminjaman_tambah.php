        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">Form Tambah Data Murid Komputer</h3>
                </div>
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="" method="post">
                     ...
                     <!--    <div class="form-group">
                            <label for="nomorf" class="col-sm-3 control-label">No pendaftaran</label>
                            <div class="col-sm-9">
                                <input type="text" name="nomor" class="form-control" id="inputEmail3" placeholder="Inputkan Nomor NRP" required>
                            </div>
                        </div> -->
                         <div class="form-group">
...
if($_POST){
    ...
    $tgl_masuk=$_POST['tgl_masuk'];
     $status=$_POST['status'];
    //buat sql
    $sql="INSERT INTO arsipkom VALUES ('$nomor','$no_kk','$nama','$alamat','$no_telpon',
