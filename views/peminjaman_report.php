        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title"><span class="fa fa-user-plus"></span> Laporan Data List Murid Komputer</h3>
                </div>
                        ...
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td><?= $data['status'] ?></td>
                                    <td>
                                        <a href="report/peminjaman_satu.php?id=<?= $data['nomor'] ?>" target="_blank" class="btn btn-info btn-xs">
